      ...
      <div className="container p-4">
        ...
        <div className="row">
          <div className="col-12">       
            ...
            <p>Product Owner: {this.state.owner}</p>

            <StartWarranty startWarranty={() => {
              this._startWarranty()
            }}/>
            <p>Warranty Start Time(Unix): {this.state.warrantyStartTime}</p>

            <ExtendWarranty extendWarranty={(input) => {
              this._extendWarranty(input)
            }}/>
            <p>Total Warranty Time(Unix): {this.state.totalWarrantyTime}</p>

            <CheckWarranty checkWarranty={() => {
              this._checkWarranty()
            }}/>
            <p>Warranty State: {this.state.warrantyState}</p>
